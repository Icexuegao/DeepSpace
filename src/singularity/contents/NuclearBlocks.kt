...
class NuclearBlocks : ContentList {
  companion object {
    lateinit var 中子能量节点: Block
    lateinit var 相位核能塔: Block
    lateinit var 中子缓冲器: Block
    lateinit var 晶体势垒: Block
    lateinit var 高压缓冲器: Block
    lateinit var 中子缓冲矩阵: Block
    lateinit var 晶体储能簇: Block
    lateinit var 环形电磁储能簇: Block
    lateinit var 衰变仓: Block
    lateinit var 中子能发电机: Block
    lateinit var 核子冲击反应堆: Block
    lateinit var 核反应堆: Block
    lateinit var 晶格反应堆: Block
    lateinit var 超核临界反应堆: Block
    lateinit var 托卡马克点火装置: Block
    lateinit var 超导约束轨道: Block
    lateinit var 潮汐约束轨道: Block
    lateinit var 核能源: Block
    lateinit var 核能黑洞: Block
  }
  ...
  override fun load() {
    ...
    相位核能塔 = NuclearNode("phase_pipe_node").apply {
      ...
      requirements(
        SglCategory.nuclear, ItemStack.with(
          IItems.强化合金, 24, IItems.FEX水晶, 16, Items.phaseFabric, 15
        )
      )
      size = 3
    ...
    中子缓冲器 = EnergyBuffer("energy_buffer").apply {
      ...
      requirements(
        SglCategory.nuclear, ItemStack.with(
          IItems.强化合金, 40, IItems.FEX水晶, 50, IItems.气凝胶, 40, Items.silicon, 60
        )
      )
      size = 2
    ...
    晶体势垒 = EnergyBuffer("crystal_buffer").apply {
      bundle {
        desc(zh_CN, "晶体势垒", "中型能量缓冲设施,具有更大的能量缓冲空间,可进行中压区调压")
      }
      requirements(
        SglCategory.nuclear, ItemStack.with(
          IItems.强化合金, 60, IItems.FEX水晶, 75, IItems.气凝胶, 50, Items.silicon, 75, Items.phaseFabric, 80
        )
      )
      size = 3
      energyCapacity = 4096f
    ...
    高压缓冲器 = EnergyBuffer("high_voltage_buffer").apply {
      ...
      requirements(
        SglCategory.nuclear, ItemStack.with(
          IItems.强化合金, 90, IItems.FEX水晶, 120, IItems.充能FEX水晶, 80, IItems.铱, 50, Items.silicon, 125, Items.phaseFabric, 90, Items.surgeAlloy, 80
        )
      )
      size = 4
      energyCapacity = 16384f
    ...
    中子缓冲矩阵 = EnergyBuffer("neutron_matrix_buffer").apply {
      ...
      requirements(
        SglCategory.nuclear, ItemStack.with(
          IItems.强化合金, 120, IItems.FEX水晶, 140, IItems.充能FEX水晶, 100, IItems.铱, 75, IItems.矩阵合金, 80, Items.phaseFabric, 100, Items.surgeAlloy, 80
        )
      )
      size = 5
    ...
    晶体储能簇 = EnergyContainer("crystal_container").apply {
      ...
      requirements(
        SglCategory.nuclear, ItemStack.with(
          IItems.FEX水晶, 160, IItems.气凝胶, 80, IItems.矩阵合金, 80, IItems.强化合金, 100, Items.silicon, 60, Items.phaseFabric, 55
        )
      )
      size = 3
    ...
    环形电磁储能簇 = EnergyContainer("magnetic_energy_container").apply {
      ...
      requirements(
        SglCategory.nuclear, ItemStack.with(
          IItems.FEX水晶, 200, IItems.充能FEX水晶, 100, IItems.矩阵合金, 120, IItems.强化合金, 120, IItems.气凝胶, 100, Items.surgeAlloy, 80, Items.silicon, 120
        )
      )
      size = 5
    ...
    衰变仓 = NormalCrafter("decay_bin").apply {
      ...
      requirements(
        SglCategory.nuclear, ItemStack.with(
          IItems.强化合金, 60, IItems.FEX水晶, 40, Items.silicon, 50, Items.lead, 80, Items.metaglass, 40
        )
      )
      size = 2
      autoSelect = true
    ...
    中子能发电机 = NormalCrafter("neutron_generator").apply {
      ...
      requirements(
        Category.power, ItemStack.with(
          IItems.强化合金, 100, IItems.充能FEX水晶, 80, IItems.铀238, 75, Items.phaseFabric, 70, IItems.气凝胶, 90
        )
      )
      size = 3
    ...
    核子冲击反应堆 = NormalCrafter("nuclear_impact_reactor").apply {
      ...
      requirements(
        Category.power, ItemStack.with(
          IItems.强化合金, 260, IItems.气凝胶, 240, IItems.铀238, 300, Items.plastanium, 220, Items.silicon, 280, Items.phaseFabric, 160, Items.surgeAlloy, 200
        )
      )
      size = 5
      itemCapacity = 30
    ...
    核反应堆 = NuclearReactor("nuclear_reactor").apply {
      ...
      requirements(
        SglCategory.nuclear,
          IItems.强化合金, 200, IItems.FEX水晶, 160, IItems.气凝胶, 180, IItems.铀238, 200, Items.lead, 180, Items.phaseFabric, 140
    ...
    晶格反应堆 = NuclearReactor("lattice_reactor").apply {
      ...
      requirements(
        SglCategory.nuclear, ItemStack.with(
          IItems.强化合金, 120, IItems.FEX水晶, 90, IItems.充能FEX水晶, 70, IItems.铀238, 100, Items.phaseFabric, 60, Items.surgeAlloy, 80
        )
      )
      size = 3
      itemCapacity = 25
    ...
    超核临界反应堆 = NuclearReactor("overrun_reactor").apply {
      ...
      requirements(
        SglCategory.nuclear, ItemStack.with(
          IItems.强化合金, 400, IItems.FEX水晶, 260, IItems.充能FEX水晶, 280, IItems.简并态中子聚合物, 100, IItems.铀238, 320, Items.surgeAlloy, 375, Items.phaseFabric, 240
        )
      )
      size = 6
      hasLiquids = true
    ...
    托卡马克点火装置 = TokamakCore("tokamak_firer").apply {
      ...
      requirements(
        SglCategory.nuclear, ItemStack.with(
          Items.phaseFabric, 160, Items.silicon, 200, Items.surgeAlloy, 160, Items.phaseFabric, 220, IItems.强化合金, 180, IItems.气凝胶, 240, IItems.FEX水晶, 160, IItems.充能FEX水晶, 120, IItems.铱, 100
        )
      )
      size = 5
    ...
    超导约束轨道 = TokamakOrbit("magnetic_confinement_orbit").apply {
      ...
      requirements(
        SglCategory.nuclear, ItemStack.with(
          Items.phaseFabric, 60, Items.surgeAlloy, 80, Items.silicon, 100, IItems.强化合金, 120, IItems.FEX水晶, 80, IItems.气凝胶, 100, IItems.铱, 60
        )
      )
      quickRotate=false
      size = 3
    ...
    潮汐约束轨道 = TokamakOrbit("tidal_confinement_orbit").apply {
      ...
      requirements(
        SglCategory.nuclear, ItemStack.with(
          Items.phaseFabric, 100, Items.surgeAlloy, 120, IItems.简并态中子聚合物, 60, IItems.强化合金, 140, IItems.FEX水晶, 100, IItems.充能FEX水晶, 80, IItems.气凝胶, 160, IItems.铱, 120
        )
      )
      size = 5
