...
class ProductBlocks : ContentList {
  companion object {
    var 岩层钻井机: Block? = null
    var 岩石粉碎机: Block? = null
    var 潮汐钻头: Block? = null
    var 引力延展室: Block? = null
    var 矩阵矿床: Block? = null
    var 采掘扇区: Block? = null
    var 矩阵增幅器: Block? = null
    var 量子隧穿仪: Block? = null
    var 谐振增压组件: Block? = null
  }

  override fun load() {
    岩层钻井机 = FloorCrafter("rock_drill").apply {
      bundle {
    ...
    岩石粉碎机 = FloorCrafter("rock_crusher").apply {
      bundle {
    ...
    潮汐钻头 = ExtendableDrill("tidal_drill").apply {
      bundle {
        desc(zh_CN, "潮汐钻头", "使用最前沿力场控制技术制造的高级钻头,以粒子束冲击破坏挖掘物的物质结构后通过控制引力场震荡完成矿石解体和采集的过程")
      }
      requirements(
        Category.production, IItems.简并态中子聚合物, 50, IItems.强化合金, 120, IItems.气凝胶, 90, IItems.充能FEX水晶, 75, IItems.铱, 40, Items.phaseFabric, 60
      )
      size = 4
    ...
    引力延展室 = ExtendMiner("force_field_extender").apply {
      ...
      requirements(
        Category.production, ItemStack.with(
          IItems.简并态中子聚合物, 20, IItems.FEX水晶, 20, IItems.铱, 8, IItems.强化合金, 30
        )
      )
      size = 2
    ...
    矩阵矿床 = object : MatrixMiner("matrix_miner") {
      init {
        bundle {
        ...
        requirements(
          Category.production, ItemStack.with(
            IItems.矩阵合金, 130, IItems.充能FEX水晶, 80, IItems.强化合金, 90, IItems.气凝胶, 90, Items.phaseFabric, 65, Items.graphite, 90, IItems.铱, 45
          )
        )
        size = 5
    ...
    采掘扇区 = object : MatrixMinerSector("matrix_miner_node") {
      init {
    ...
    谐振增压组件 = object : MatrixMinerComponent("matrix_miner_extend") {
      init {
        bundle {
        ...
        requirements(
          Category.production, ItemStack.with(
            IItems.矩阵合金, 40, IItems.充能FEX水晶, 40, IItems.强化合金, 60, IItems.铱, 12, IItems.简并态中子聚合物, 20
          )
        )
        size = 3
    ...
    量子隧穿仪 = object : MatrixMinerComponent("matrix_miner_pierce") {
      init {
        bundle {
        ...
        requirements(
          Category.production, ItemStack.with(
            IItems.矩阵合金, 40, IItems.充能FEX水晶, 40, IItems.FEX水晶, 50, IItems.强化合金, 30, IItems.铱, 20, Items.phaseFabric, 40
          )
        )
        size = 3
    ...
    矩阵增幅器 = object : MatrixMinerComponent("matrix_miner_overdrive") {
      init {
        bundle {
        ...
        requirements(
          Category.production, ItemStack.with(
            IItems.矩阵合金, 40, IItems.充能FEX水晶, 50, IItems.强化合金, 40, IItems.气凝胶, 40, IItems.铱, 15, Items.phaseFabric, 60
          )
        )
        size = 3
        range = 16
