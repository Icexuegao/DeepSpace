      ...
      init {
        requirements(
          Category.units, ItemStack.with(
            Items.silicon, 180, Items.surgeAlloy, 160, Items.phaseFabric, 190, IItems.铝锭, 200, IItems.气凝胶, 120, IItems.强化合金, 215, IItems.矩阵合金, 180, IItems.FEX水晶, 140, IItems.铱锭, 100
          )
        )
        size = 7
        liquidCapacity = 280f
