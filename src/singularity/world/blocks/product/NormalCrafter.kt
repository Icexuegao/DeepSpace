...
open class NormalCrafter(name: String) : SglBlock(name), FactoryBlockComp {
    ...
    override var warmupSpeed: Float = 0.02f
    override var stopSpeed: Float = 0.02f
    var byproducts: OrderedMap<BaseConsumers?, Byproduct> = OrderedMap<BaseConsumers?, Byproduct>()
    var optionalProducts: OrderedMap<BaseConsumers?, BaseProducers?> = OrderedMap<BaseConsumers?, BaseProducers?>()
    var boosts: ObjectFloatMap<BaseConsumers?> = ObjectFloatMap<BaseConsumers?>()
