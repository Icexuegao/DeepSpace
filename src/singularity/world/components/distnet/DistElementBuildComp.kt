...
interface DistElementBuildComp : BuildCompBase {
  var distributor: DistributeModule

  // @Annotations.BindField("priority")
  var priority: Int

  // @Annotations.BindField(value = "", initialize = "new arc.struct.Seq<>()")
  var netLinked: Seq<DistElementBuildComp>

  // @Annotations.BindField("matrixEnergyBuffered")
  var matrixEnergyBuffered: Float
