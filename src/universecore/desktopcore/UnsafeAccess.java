...
public class UnsafeAccess{
  ...
  public static void set(Field field, Object object, Object value) throws IllegalHandleException {
  ...
  protected static void doPut(Object value, Object base, long fieldOff, Class<?> clazz){
    if(clazz.isPrimitive()){
      if(clazz == int.class) unsafe.putInt(base, fieldOff, (int) value);
          ...
          throw new IllegalHandleException("unknown type of field " + clazz);
    ...
    if(Modifier.isVolatile(field.getModifiers())){
      if(clazz.isPrimitive()){
        if(clazz == int.class) return unsafe.getIntVolatile(object, fieldOff);
            ...
            throw new IllegalHandleException("unknown type of field " + field);
          } catch (IllegalHandleException e) {
            throw new RuntimeException(e);
          }
      }
  ...
  private static class IllegalHandleException extends Throwable {
    public IllegalHandleException(String s) {
    }
  }
}
