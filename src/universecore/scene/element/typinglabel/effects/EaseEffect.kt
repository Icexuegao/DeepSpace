...
package universecore.scene.element.typinglabel.effects

import arc.math.Interp
import arc.math.Mathf
import arc.struct.IntFloatMap
import universecore.scene.element.typinglabel.Effect
import universecore.scene.element.typinglabel.TypingGlyph
...
class EaseEffect(label: TLabel, params: Array<String?>) : Effect(label) {
    ...
    override fun onApply(glyph: TypingGlyph, localIndex: Int, delta: Float) {
        ...
        val y = lineHeight * distance * interpolatedValue * DEFAULT_DISTANCE
    ...
    companion object {
        private const val DEFAULT_DISTANCE = 0.15f
        private const val DEFAULT_INTENSITY = 0.075f
    }
}
