package universecore.scene.element.typinglabel
...
interface TypingListener {
     ...
     * direct values, unless `null` is returned.
     *
     ...
     * @return The replacement String, or `null` if this method should be ignored and the regular values should be
     * used instead.
     * @see TLabel.setVariable
     * @see TLabel.setVariables
     */
    fun replaceVariable(variable: String?): String?
