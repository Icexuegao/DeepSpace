...
import universecore.reflection.fieldAccessors.*
import universecore.reflection.fieldAccessors.staticAccessors.*
import universecore.reflection.methodInvoker.*
import universecore.reflection.methodInvoker.staticInvoker.*
...
inline fun <C :Any, reified R> KClass<C>.accessMethod0(name: String) = StaticInvoker0<R>(
  this.java.getDeclaredMethod(name).also {
    checkReturnType(it, R::class.java)
    it.isAccessible = true
  })
