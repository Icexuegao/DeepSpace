...
import static universecore.ui.elements.markdown.highlighter.Scope.Default.RainbowSeparator;
...
public class MarkdownStyles {
  ...
  static {
    ...
    try {
      temp = makeDefault(ice.ui.Fonts.INSTANCE.getMono());
    } catch (Exception e) {
      Log.err(e);
  ...
  public static Markdown.MarkdownStyle makeDefault(Font mono) {
    return new Markdown.MarkdownStyle() {{
      ...
      listMarks = new Drawable[]{new BaseDrawable() {
        @Override
      ...
      codeColorProvider.createMap("java").put(Color.valueOf("#ffffff00"), SPACE).put(Color.valueOf("#676d9dff"), COMMENT).put(Color.valueOf("#CC7832ff"), KEYWORD, CONTROL, SEPARATOR).put(Color.valueOf("#6897bbff"), NUMBER).put(Color.valueOf("#be7032ff"), TYPE).put(Color.valueOf("#507874ff"), TYPE_ARG).put(Color.valueOf("#6a8759ff"), STRING).put(Color.valueOf("#bbb529ff"), ANNOTATION).put(Color.valueOf("#629755ff"), DOCS, DOC_MARK).put(Color.valueOf("#ffc66dff"), FUNCTION).put(Color.valueOf("#3c7893ff"), CONSTRUCTOR).put(Color.valueOf("#bfbfbfff"), NONE, FUNCTION_INVOKE, ARGUMENT, VARIABLE, OPERATOR);
      codeColorProvider.createMap("lua").put(Color.valueOf("#ffffff00"), SPACE).put(Color.valueOf("#7f7f7fff"), COMMENT).put(Color.valueOf("#c09df6ff"), KEYWORD).put(Color.valueOf("#c09df6ff"), KEYWORD_BODY).put(Color.valueOf("#dbaad9ff"), KEYWORD_CONTROL).put(Color.valueOf("#ff7382ff"), KEYWORD_SELF).put(Color.valueOf("#f89876ff"), KEYWORD_VAR1).put(Color.valueOf("#6fb8ffff"), KEYWORD_VAR2).put(Color.valueOf("#5fd3c0ff"), TABLE_VARS).put(Color.valueOf("#9cd7f1ff"), CONTROL, SEPARATOR, OPERATOR).put(Color.valueOf("#ee9c7cff"), NUMBER).put(Color.valueOf("#e47c8fff"), SEPARATOR).put(Color.valueOf("#f4c87cff"), ARGUMENT).put(Color.valueOf("#c5e59aff"), STRING).put(Color.valueOf("#82a3f2ff"), FUNCTION).put(Color.valueOf("#6fb8ffff"), FUNCTION_INVOKE).put(Color.valueOf("#82a3f2ff"), KEYWORD_FUNCTION).put(Color.valueOf("#ccd4f2ff"), NONE, VARIABLE, LOCAL_VARS).putProv(scope -> scope instanceof RainbowSeparator, (RainbowSeparator scope) -> switch (scope.depth) {
