package universecore.ui.effects;
...
public class SceneEffect extends Element implements Pool.Poolable {
  ...
  public float time;
  public Object data;
  private Cons<SceneEffect> runnable;

  public static SceneEffect showOnStage(Effect fx, float x, float y, Cons<SceneEffect> runnable){
    SceneEffect sceneEffect = showOnStage(fx, x, y, 0, Color.white, null);
  ...
  public void act(float delta){
    ...
    time += Time.delta;
    if(runnable != null) runnable.get(this);
    if(time > lifetime){
      remove();
    }
  }
