...
import static ice.graphics.SglDraw.*;
...
public class Distortion implements Disposable {
    ...
    public Distortion() {
        distortion = new Shader(Core.files.internal("shaders/screenspace.vert"), SglShaders.internalShaderDir.child("distortion.frag"));
