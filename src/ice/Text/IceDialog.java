...
public class IceDialog extends Table {
    private static final Prov<Action> defaultShowAction = ()->Actions.sequence(Actions.alpha(0), Actions.fadeIn(0.4f, Interp.fade));
    private static final Prov<Action> defaultHideAction = ()->Actions.fadeOut(0.4f, Interp.fade);
