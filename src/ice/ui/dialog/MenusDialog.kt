...
import ice.library.scene.texs.Texs.deepSpaceVer
...
object MenusDialog : Table() {
    ...
    var button: MeunsButton = MeunsButton.日志
        ...
        table(back){ table ->
            ...
            table.table { it1 ->
                ...
                it1.table(back) { it2 ->
                    ...
                    it2.table { it.add(Image(Texs.flower)).color(Colors.b5).expand().bottom() }.grow()
