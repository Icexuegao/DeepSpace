package ice.library.type.baseContent.blocks.science
...
import ice.library.type.baseContent.blocks.IceBlockComponents.calwavetimeremain
...
class Laboratory(name: String) : IceBlock(name) {
    ...
    init {
        ...
        requirements(Category.effect, ItemStack.with(IceItems.石英玻璃, 50))
