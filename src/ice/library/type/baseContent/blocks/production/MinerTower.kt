package ice.library.type.baseContent.blocks.production
...
class MinerTower(name: String) : Block(name) {
    ...
    override fun drawPlace(x: Int, y: Int, rotation: Int, valid: Boolean) {
        ...
        Drawf.circles((x * tilesize+ offset), (y * tilesize+offset), (minerRange * 8).toFloat(), Colors.b4)
    }
    ...
    inner class MinerTowerBuild : Building() {
        ...
        override fun drawSelect() {
            super.drawSelect()
            Drawf.circles(x, y, (minerRange * 8).toFloat(), Colors.b4)
        }
...
val range=16
           ...
           var y=dy
            ...
            Fx.lightning.at(x, y, angle, Colors.b1, lines)
        }
    }
}
