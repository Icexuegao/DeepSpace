...
object IceStats {
    ...
    val 可连接建筑 = IceStat("linkBlocks")
    val 最大连接 = IceStat("maxLinks")
    ...
    class IceStat(name: String, category: StatCat = IceStatCats.deepSpace) : Stat(name, category) {
