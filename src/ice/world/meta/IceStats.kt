...
object IceStats :Load {
  ...
  val 关闭 = getStat("close") {
    localization {
      zh_CN {
        this.localizedName = "关闭"
      }
      en {
        this.localizedName = "close"
      }
    }
  }
  val 科技 = getStat("tree") {
    localization {
      zh_CN {
        this.localizedName = "科技"
      }
      en {
        this.localizedName = "Tech Tree"
      }
    }
  }
  val 研究 = getStat("research") {
    localization {
      zh_CN {
        this.localizedName = "研究"
      }
      en {
        this.localizedName = "Research"
      }
    }
  }
  val 数据 = getStat("datas") {
    localization {
      zh_CN {
        this.localizedName = "数据"
      }
      en {
        this.localizedName = "Data"
      }
    }
  }
  val 成就 = getStat("achievement") {
    localization {
      zh_CN {
        this.localizedName = "成就"
      }
      en {
        this.localizedName = "Achievements"
      }
    }
  }
  val 遗物 = getStat("remains") {
    localization {
      zh_CN {
        this.localizedName = "遗物"
      }
      en {
        this.localizedName = "Relics"
      }
    }
  }
  val 设置 = getStat("settings") {
    localization {
      zh_CN {
        this.localizedName = "设置"
      }
      en {
        this.localizedName = "Settings"
      }
    }
  }
  val 日志 = getStat("logs") {
    localization {
      zh_CN {
        this.localizedName = "日志"
      }
      en {
        this.localizedName = "Logs"
      }
    }
  }
  val 公告 = getStat("publicInfo") {
    localization {
      zh_CN {
        this.localizedName = "公告"
      }
      en {
        this.localizedName = "Announcements"
      }
    }
  }
  val 连接 = getStat("links") {
    localization {
      zh_CN {
        this.localizedName = "连接 {0}/{1}"
      }
      en {
        this.localizedName = "Links {0}/{1}"
      }
    }
  }
  ...
  val 支持详情 = getStat("support.info") {
    localization {
      zh_CN {
        this.localizedName = "首先,谢谢您愿意点开这个页面,若您喜欢这个mod,您的支持将是我们继续这个项目的莫大动力"
      }
    }
  }
  val 支持github = getStat("support.star") {
    localization {
      zh_CN {
        this.localizedName = "如果您想要支持这个mod,我们比较推荐您从下面的这个按钮跳转到这个项目的github页面,并为我们点亮一个star"
      }
    }
  }
  val 支持githubStar = getStat("support.githubStar") {
    localization {
      zh_CN {
        this.localizedName = "前往mod的github页面,并点亮一个star"
      }
    }
  }
  ...
  val 支持爱发电 = getStat("support.afdian") {
    localization {
      zh_CN {
        this.localizedName = "来自中国的玩家可以选择通过爱发电赞助"
      }
    }
  }
  val 支持patreon = getStat("support.patreon") {
    localization {
      zh_CN {
        this.localizedName = "通过patreon赞助我们"
      }
    }
  }
