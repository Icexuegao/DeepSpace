...
abstract class FleshEntity : Entity() {
  override fun destroy() {
    ...
    repeat((hitSize / 3).toInt()) {
      Effect.decal(青壤.SchizovegetaUnit.scorchs.random(), x + Mathf.random(-hitSize, hitSize), y + Mathf.random(-hitSize, hitSize), Mathf.random(4) * 90f, 3600f, Color.white.cpy().a(0f))
    }
