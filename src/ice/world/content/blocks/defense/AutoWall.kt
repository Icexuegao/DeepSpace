...
class AutoWall(name: String) : Wall(name) {
    ...
    inner class AutoWallBuild : IceBuild() {
        ...
        override fun draw() {
            ...
            else if (tileX() == (tileX() and 1.inv()) && tileY() == (tileY() and 1.inv()))
        ...
        fun proximityTileUpdate() {
            ...
            isLarge =
                checkBuild(Vars.world.build(xLarge, yLarge)) &&
                checkBuild(Vars.world.build(xLarge + 1, yLarge)) &&
                checkBuild(Vars.world.build(xLarge, yLarge + 1)) &&
