...
class AbyssPrison :IceUnitType("unit_abyssPrison") {
  init {
    localization {
      zh_CN {
        localizedName = "渊狱"
        // 如果JSON中有description也可以在此添加
      }
    }
  ...
  private fun setWeapon() {
    ...
    setWeapon("energyGatheringCannon") {
      ...
      bullet = ContinuousLaserBulletType().apply {
        ...
        lifetime = 240f
        shake = 0.5f
        status = IStatus.熔融 // 对应 "熔融"
        statusDuration = 60f
        incendChance = 1f
        incendAmount = 5
        colors = arrayOf(
          Color.valueOf("D75B6E"), Color.valueOf("BF3E47"), Color.valueOf("FF8663")
        )
