...
class RainFly :IceUnitType("unit_rainFly", EntityC::class.java) {
  init {
    localization {
      zh_CN {
        localizedName = "雨燕"
  ...
  private class EntityC :Entity() {
    ...
    fun drawRotatorShadow(unit: Unit, name: String, x: Float, y: Float, shadowX: Float, shadowY: Float, speed: Float, s: Float, mirror: Boolean =false) {
