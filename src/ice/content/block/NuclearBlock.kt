...
object NuclearBlock : Load{
  ...
  var 高压缓冲器 = EnergyBuffer("high_voltage_buffer").apply {
    ...
    requirements(
      SglCategory.nuclear, ItemStack.with(
        IItems.强化合金, 90, IItems.FEX水晶, 120, IItems.充能FEX水晶, 80, IItems.铱锭, 50, Items.silicon, 125, Items.phaseFabric, 90, Items.surgeAlloy, 80
      )
    )
    size = 4
    energyCapacity = 16384f
  ...
  var 中子缓冲矩阵 = EnergyBuffer("neutron_matrix_buffer").apply {
    ...
    requirements(
      SglCategory.nuclear, ItemStack.with(
        IItems.强化合金, 120, IItems.FEX水晶, 140, IItems.充能FEX水晶, 100, IItems.铱锭, 75, IItems.矩阵合金, 80, Items.phaseFabric, 100, Items.surgeAlloy, 80
      )
    )
    size = 5
  ...
  var 核反应堆 = NuclearReactor("nuclear_reactor").apply {
    ...
    requirements(
      SglCategory.nuclear, IItems.强化合金, 200, IItems.FEX水晶, 160, IItems.气凝胶, 180, IItems.铀238, 200, Items.lead, 180, Items.phaseFabric, 140
    )
    size = 4
    itemCapacity = 35
    liquidCapacity = 25f
  ...
  var 托卡马克点火装置 = TokamakCore("tokamak_firer").apply {
    ...
    requirements(
      SglCategory.nuclear, ItemStack.with(
        Items.phaseFabric, 160, Items.silicon, 200, Items.surgeAlloy, 160, Items.phaseFabric, 220, IItems.强化合金, 180, IItems.气凝胶, 240, IItems.FEX水晶, 160, IItems.充能FEX水晶, 120, IItems.铱锭, 100
      )
    )
    size = 5
  ...
  var 超导约束轨道 = TokamakOrbit("magnetic_confinement_orbit").apply {
    ...
    requirements(
      SglCategory.nuclear, ItemStack.with(
        Items.phaseFabric, 60, Items.surgeAlloy, 80, Items.silicon, 100, IItems.强化合金, 120, IItems.FEX水晶, 80, IItems.气凝胶, 100, IItems.铱锭, 60
      )
    )
    quickRotate = false
    size = 3
  ...
  var 潮汐约束轨道 = TokamakOrbit("tidal_confinement_orbit").apply {
    ...
    requirements(
      SglCategory.nuclear, ItemStack.with(
        Items.phaseFabric, 100, Items.surgeAlloy, 120, IItems.简并态中子聚合物, 60, IItems.强化合金, 140, IItems.FEX水晶, 100, IItems.充能FEX水晶, 80, IItems.气凝胶, 160, IItems.铱锭, 120
      )
    )
    size = 5
