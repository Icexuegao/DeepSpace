...
import ice.library.type.baseContent.unit.IceUnitEngine
import ice.library.type.baseContent.unit.ability.BarAbility
import ice.library.type.baseContent.unit.type.IceTankUnitType
import ice.library.type.baseContent.unit.type.IceUnitType
import ice.library.type.baseContent.unit.unitEntity.ClusterLobesUnit
import ice.library.type.baseContent.unit.unitEntity.WitchUnit
...
object IceUnitTypes {
    ...
    val 焚棘= IceUnitType("ardenThorn").apply {
        constructor = Prov(UnitEntity::create)
        flying=true
        speed=2f
        hitSize=40f
        abilities.add(RotatorAbility("propeller",13f,10f,5f,true))
    }
}
/*
