...
public class IceJval {
    ...
    public static IceJval valueOf(int value){ return new IceJval(value); }
    public static IceJval valueOf(long value){ return new IceJval(value); }
    public static IceJval valueOf(float value){ return new IceJval(value); }
    public static IceJval valueOf(double value){ return new IceJval(value); }
    public static IceJval valueOf(String string){ return string == null ? NULL : new IceJval(string); }
    public static IceJval valueOf(boolean value){ return value ? TRUE : FALSE; }
