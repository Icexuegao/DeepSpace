...
import ice.Alon.graphics.IceColors
...
class IcePlanets {
    ...
    companion object {
        ...
        fun load() {
            object : Planet("alon", Planets.sun, 1f, 3) {
                ...
                generator = object : PlanetGenerator() {
                    ...
                    override fun genTile(position: Vec3?, tile: TileGen?) {
                        if (tile != null) {
                            tile.floor = EnvironmentBlocks.redIce
                        }
                    ...
                    override fun generate(tiles: Tiles?) {
                        ...
                        tiles?.eachTile {
                            ...
                            if (snoise >= 0.5) {
                                ...
                                val liparite = EnvironmentBlocks.liparite
                                if (liparite is Floor) {
                                    ...
                                    if (noise2d >= 0.5) {
                                        it.setBlock(EnvironmentBlocks.lipariteWall)
                                    }
