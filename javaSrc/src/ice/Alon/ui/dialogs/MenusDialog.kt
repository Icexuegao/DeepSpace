...
import ice.Alon.library.draw.IceDrawf.createFlatDown
...
class MenusDialog internal constructor() {
    ...
    private var graphicsSize = if (!Vars.mobile) floatArrayOf(
    ...
    private val deepSpaceColor = arrayOf("#C384B7", "red", "#1DFF00", "#FFECF8FF")
