...
public class IceLightning {
    ...
    public static void createLightningInternal(@Nullable Bullet hitter, int seed, Team team, Color color, float damage, float x, float y, float rotation, int length) {
        random.setSeed(seed);
        hit.clear();
        ...
        IceEffects.lightning.at(x, y, new Random().nextInt(361), color,lines);
