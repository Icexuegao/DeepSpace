    ...
    public static void load() {
        new
                Wall("test3") {{
                    ...
                    buildType = () -> new WallBuild() {
                        @Override
                        public void update() {
                            Tile tile =world.tiles.get((int) x, (int) (y+1));
                            if (tile!=null){
                                Log.info("检测到实体");
                              tile.build=null;
                            }
        ...
        new Wall("test2") {{
            ...
            public boolean canPlaceOn(Tile tile, Team team, int rotation) {
                Tile tile1 = world.tile(tile.x, tile.y + 2);
            ...
            buildType = () -> new WallBuild() {
                ...
                public void draw() {
                    ...
                    for (Point2 e : visited) {
                        Fill.crect(e.x * tilesize - tilesize / 2, e.y * tilesize - tilesize / 2, tilesize, tilesize);
                    }
                    Draw.reset();
                }
            };
