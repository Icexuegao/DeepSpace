...
public class IceEffect {
    ...
    static {
        gc /**  烟雾 */ = new Effect(60.0F, (e) -> Angles.randLenVectors(e.id, 6, 8.0F + e.fin() * 5.0F, (x, y) -> {
            Draw.color(Color.valueOf("ff7439"), e.color, e.fin());
            Fill.square(e.x + x, e.y + y, 0.5F + e.fout() * 2.0F, 45.0F);
        }));
        gc1 /**  方块 */ = new Effect(80.0F, (e) -> Angles.randLenVectors(e.id, 0.2F + e.fin(), 4, 6.3F, (x, y, fin, out) -> {
