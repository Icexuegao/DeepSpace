...
public class wakuangpaota extends BaseTurret {
    ...
    public wakuangpaota(String name) {
        super(name);
        buildType = wankungbuild::new;
        sync = true;
        hasItems = true;
        outlineIcon = true;
    }
    ...
    public class wankungbuild extends BaseTurretBuild {
        ...
        public void updateTile() {
            ...
            if (mineTile != null) {
                ...
                if (mineTimer >= 50f + item.hardness * 15f) {
                    ...
                    InputHandler.transferItemTo(null, item, 1, mineTile.worldx() + Mathf.range(tilesize / 2f), mineTile.worldy() + Mathf.range(tilesize / 2f), this);
                }
