package ice.asundry.BaseTool.io;
 ...
 */
public class IceJval {
    public static final IceJval
            TRUE = new IceJval(true),
            FALSE = new IceJval(false),
            NULL = new IceJval(null);
    ...
    IceJval(Object value) {
        this.value = value;

        if (getType() == null) throw new IllegalArgumentException("Invalid JSON value: " + value);
    }

    public static IceJval newObject() {
        return new IceJval(new JsonMap());
    }

    public static IceJval newArray() {
        return new IceJval(new JsonArray());
    }
     ...
     */
    public static IceJval read(Reader reader) {
        try {
    ...
    public static IceJval read(byte[] bytes) {
        try {
     ...
     * @return the Hjson value that has been read
     */
    public static IceJval read(String text) {
        try {
    ...
    public static IceJval valueOf(int value) {
        return new IceJval(value);
    }

    public static IceJval valueOf(long value) {
        return new IceJval(value);
    }

    public static IceJval valueOf(float value) {
        return new IceJval(value);
    }

    public static IceJval valueOf(double value) {
        return new IceJval(value);
    }

    public static IceJval valueOf(String string) {
        return string == null ? NULL : new IceJval(string);
    }

    public static IceJval valueOf(boolean value) {
    ...
    public JsonMap asObject() {
        if (!(value instanceof JsonMap)) throw new UnsupportedOperationException("Not an object: " + this);
        return (JsonMap) value;
    }

    public JsonArray asArray() {
        if (!(value instanceof JsonArray)) throw new UnsupportedOperationException("Not an array: " + this);
    ...
    public boolean asBool() {
        if (!(value instanceof Boolean)) throw new UnsupportedOperationException("Not a bool: " + this);
        return (Boolean) value;
    }

    public Number asNumber() {
        if (!(value instanceof Number)) throw new UnsupportedOperationException("Not a number: " + this);
        return ((Number) value);
    }

    public IceJval get(String name) {
        if (name == null) throw new NullPointerException("name is null");
        return asObject().get(name);
    }

    public void add(String name, IceJval val) {
        if (name == null) throw new NullPointerException("name is null");
    ...
    public IceJval add(IceJval value) {
        asArray().add(value);
        return this;
    }

    public IceJval add(String value) {
        asArray().add(new IceJval(value));
        return this;
    }

    public IceJval add(Number value) {
        asArray().add(new IceJval(value));
        return this;
    }

    public IceJval add(boolean value) {
        asArray().add(new IceJval(value));
        return this;
    }

    public IceJval put(String name, IceJval val) {
        if (val != null) add(name, val);
        return this;
    }

    public IceJval put(String name, String val) {
        if (val != null) add(name, val);
        return this;
    }

    public IceJval put(String name, Number val) {
        if (val != null) add(name, new IceJval(val));
        return this;
    }

    public IceJval put(String name, boolean val) {
        add(name, new IceJval(val));
        return this;
    }

    public IceJval remove(String name) {
        if (name == null) throw new NullPointerException("name is null");
    ...
    public String toString() {
        ...
        switch (type) {
            case nil:
                return "null";
            case number:
                return (value.toString().endsWith(".0") ? value.toString().replace(".0", "") : value.toString()).replace('E', 'e');
            case string:
            case bool:
    ...
    public boolean equals(Object object) {
        return object != null && object.getClass() == getClass() &&
                ((value == null && ((IceJval) object).value == null)
                        || (((IceJval) object).value != null && value != null && value.equals(((IceJval) object).value)));
    }
     ...
     */
    public static class JsonMap extends ArrayMap<String, IceJval> {
     ...
     */
    public static class JsonArray extends Seq<IceJval> {
    ...
    static class Hparser {
        ...
        static IceJval tryParseNumber(StringBuilder value, boolean stopAtNext) {
            ...
            if (!str.contains(".") && !str.contains(",") && !str.contains("e")) {
                try {
                    return new IceJval(Long.parseLong(str));
                } catch (NumberFormatException ignored) {
                }
            }

            return new IceJval(Double.parseDouble(str));
        }

        static IceJval tryParseNumber(String value) throws IOException {
        ...
        IceJval parse() throws IOException {
        ...
        IceJval checkTrailing(IceJval v) throws JsonParseException, IOException {
            skipWhiteSpace();
            if (!isEndOfText()) throw error("Extra characters in input: " + current);
            return v;
        }

        private IceJval readValue() throws IOException {
            switch (current) {
                case '\'':
                case '"':
                    return readString();
        ...
        private IceJval readTfnns() throws IOException {
                    ...
                    switch (first) {
                        ...
                        default:
                            if (first == '-' || first >= '0' && first <= '9') {
                                IceJval n = tryParseNumber(value, false);
                                if (n != null) return n;
                            }
                    }
                    if (isEol) {
                        ...
                        return new IceJval(value.toString().trim());
                    }
                }
                value.append((char) current);
            }
        ...
        private IceJval readArray() throws IOException {
            isArray = true;
            read();
            JsonArray array = new JsonArray();
            skipWhiteSpace();
            if (readIf(']')) {
                return new IceJval(array);
            }
            while (true) {
                skipWhiteSpace();
                array.add(readValue());
        ...
        private IceJval readObject(boolean objectWithoutBraces) throws IOException {
        ...
        private IceJval readString() throws IOException {
            return new IceJval(readStringInternal(true));
        }
        ...
        private JsonParseException expected(String expected) {
            ...
            return error("Expected " + expected + ",缺少字符:" + expected + "?");
        }
    ...
    public static class JsonParseException extends RuntimeException {
        ...
        JsonParseException(String message, int offset, int line, int column) {
            super(message + "在" + line + "行的第" + column + "个字符\n实际位置略有偏差");
            this.offset = offset;
            this.line = line;
            this.column = column;
        }
    ...
    static class Hwriter {
        ...
        public void save(IceJval value, Writer tw, int level, String separator, boolean noIndent) throws IOException {
            if (value == null) {
                tw.write(separator);
                tw.write("null");
                return;
            ...
            switch (value.getType()) {
                case object:
                    ...
                    for (ObjectMap.Entry<String, IceJval> pair : obj) {
    ...
    static class Jwriter {
        ...
        public void save(IceJval value, Writer tw, int level) throws IOException {
